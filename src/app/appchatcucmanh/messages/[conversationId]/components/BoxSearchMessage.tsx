...
function BoxSearchMessage() {
  ...
  const bgScrollbar = useColorModeValue("#e5e5e5", "#1c1e21");
  ...
  return (
    <>
      <HStack
        ...
        position="relative"
      >
        <CustomIcons.icon_search_message color="#53aa91" />
        <Input
          autoFocus
          type="text"
          id="search-input"
                ...
                <Button
                  ...
                  onClick={() => {
                    const getMessages = async () => {
                      ...
                      setSearchMessageValue(item.content);
                    };
                    getMessages();
                  }}
                >
      ...
      <Button
        ...
        borderRadius="50%"
        p="0"
        color={searchMessageResult.length > 0 ? "#53aa91" : ""}
